...
*/
function taraven_get_archive_template() {  
...
*/
function taraven_get_single_template() {  
...
*/
function taraven_get_page_template() {
  global $post;
...
*/
function taraven_get_current_category() {
  global $wp_query;
  global $post;
...
*/
function taraven_breadcrumb ($show_home=false) {
...
*/
function taraven_get_gallery_images($post_id) {
...
* Pagination
*/
function taraven_pagination($txt_previus=null, $txt_next=null) {
...
function getExcerpt($post_or_id='', $sizeExcerpt = 35 , $excerpt_more = ' [...]') {
...
if( !function_exists('key_change') ) {
  function key_change($array, $keymap) {
